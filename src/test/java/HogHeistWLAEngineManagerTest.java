...
public class HogHeistWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(HogHeistWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/HogHeistWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/HogHeistWLAIW/InitOutcome.xml").getDocumentElement();
